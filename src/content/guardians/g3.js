...
export default {
  brief: {
    ...
    ka: 'ახლა, სადღაც, მანქანა პაროლებს ცდის - მილიარდობით ვარიანტს წამში, შესვენებისა და სადილის გარეშე. დღეს მას შენი ანგარიშები შეხვდება. ჯერ ნახავ, რამდენ ხანს უძლებს თითოეული კარი. მერე ააგებ ციხესიმაგრეს, რომელზეც მანქანა ხელს ჩაიქნევს.',
  },
  theory: [
    {
      ...
      ka: 'გამტეხი მანქანები წამში მილიარდობით პაროლს ცდიან. მათ სიგრძე აჩერებს: ოთხი შემთხვევითი სიტყვა საუკუნეებს უძლებს, მოკლე „ეშმაკური“ პაროლი კი საათებში ეცემა.',
    },
    {
