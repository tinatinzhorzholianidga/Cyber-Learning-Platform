// The printable Family Media Agreement (spec B2). Filled in together,
// signed by both sides, revisited as the child earns autonomy.
export default {
  ...
  sections: [
    {
      ...
      clauses: [
        ...
        { en: 'We will revisit this agreement together every ______ months.', ka: 'ამ შეთანხმებას ერთად გადავხედავთ ყოველ ______ თვეში.' },
      ],
    },
    {
    ...
    {
      title: { en: 'We agree (parents)', ka: 'ვთანხმდებით (მშობლები)' },
      clauses: [
    ...
    {
      title: { en: 'Our own rules', ka: 'ჩვენი საკუთარი წესები' },
      writeLines: 3,
    },
  ],
  signatures: {
    child: { en: 'Signature (child / teen)', ka: 'ხელმოწერა (შვილი / მოზარდი)' },
    parent: { en: 'Signature (parent)', ka: 'ხელმოწერა (მშობელი)' },
