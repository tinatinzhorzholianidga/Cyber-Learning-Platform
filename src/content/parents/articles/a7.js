      ...
      ps: [
        {
          ...
          ka: '„გიო, ნახე ეს - ვნახე და, გულწრფელად, არ ვიცი, ნამდვილია თუ არა. დამეხმარები შემოწმებაში? ვნახოთ, პირველად ვინ გამოაქვეყნა და წერს თუ არა ამას რომელიმე ნამდვილი საინფორმაციო საიტი. დავენიძლავები, პასუხს ჩემზე მალე იპოვი.“',
        },
      ],
    },
